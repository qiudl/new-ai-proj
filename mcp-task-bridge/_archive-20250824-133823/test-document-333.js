...
async function testDocumentTools() {
    ...
    const testTaskId = 333; // 使用已知存在的任务
    ...
    const getResult = await taskServer.getTaskDocument(testTaskId);
    ...
    const getUpdatedResult = await taskServer.getTaskDocument(testTaskId);
