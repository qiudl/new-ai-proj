...
46	1	31周-01-01：分析计时器的bugs原因	The current code is registering the old timer handler routes\n  (/api/v1/timer/start, /api/v1/timer/stop) but the frontend is trying to call\n  the new personal timer routes (/api/v1/user/timer/stop)	in_progress	\N	\N	{"assignee": "", "priority": "high", "sequence": 1, "batch_created": true, "original_title": "分析计时器的bugs原因", "estimated_hours": 1, "batch_created_at": "2025-08-01T15:29:15.530Z"}	2025-08-01 15:29:15.584265+00	45	2	0	\N	2025-08-01 15:29:15.584265+00	0	\N
47	1	31周-01-02：启动计时器权限不足bug	personalTimerService.ts:210 \n POST http://localhost/api/v1/user/timer/start-personal 403 (Forbidden)\nconsoleFilter.ts:31 Failed to start timer: AppError: 权限不足\n    at api.ts:118:1\n    at async Object.startPersonalTimer (personalTimerService.ts:210:1)\n    at async TimerContext.tsx:283:1\n    at async Object.onClick (MVPTaskDetailTimer.tsx:159:1)\n	in_progress	\N	\N	{"tags": [], "priority": "medium"}	2025-08-01 15:36:46.531296+00	45	2	0	\N	2025-08-01 15:36:46.531296+00	0	\N
45	1	31周-01：修复定时器		todo	34	\N	{"tags": [], "priority": "medium", "progress": 0}	2025-08-01 13:27:38.72271+00	\N	0	0	\N	2025-08-01 15:36:46.531296+00	0	\N
\.
...
34	qiudl	$2a$10$P9CtyjQElBgJ4wEmsP8G2uzU8EIiPLgpIxRawkTB45K4AovegX81C	admin	2025-07-20 04:26:16.82371+00	2025-08-01 16:32:48.387165+00	qiudl@joylodging.com	active	{}	\N	\N	\N	stopped	system	\N	\N	\N	\N	\N	f	\N	\N	\N	\N
\.
...
SELECT pg_catalog.setval('public.task_time_logs_id_seq', 13, true);
...
SELECT pg_catalog.setval('public.timeline_events_id_seq', 51, true);
