...
SELECT pg_catalog.setval('public.task_updates_id_seq', 75, true);
...
SELECT pg_catalog.setval('public.tasks_id_seq', 103, true);
...
SELECT pg_catalog.setval('public.timeline_events_id_seq', 234, true);
