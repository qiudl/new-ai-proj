...
class RealVersionHistoryService {
  ...
  async compareVersions(
    ...
    try {
      const response = await api.get(
        `/api/v1/projects/${projectId}/tasks/${taskId}/documents/${documentId}/versions/compare`,
        {
          params: {
            version1: version1Id,
            version2: version2Id
  ...
  async rollbackToVersion(
    ...
    try {
      const response = await api.post(
        `/api/v1/projects/${projectId}/tasks/${taskId}/documents/${documentId}/versions/restore`,
        {
  ...
  async getVersionStatistics(
    ...
    try {
      const response = await api.get(
        `/api/v1/projects/${projectId}/tasks/${taskId}/documents/${documentId}/versions/stats`
      );
  ...
  async getVersionDetail(
    ...
    try {
      const response = await api.get(
        `/api/v1/projects/${projectId}/tasks/${taskId}/documents/${documentId}/versions/${versionId}`
      );
