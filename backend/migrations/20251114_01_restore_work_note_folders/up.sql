-- 20251114_01_restore_work_note_folders/up.sql
-- 恢复 work_note_folders 表 (修复前端API错误)
-- 作者: Claude AI
-- 日期: 2025-11-14
-- 原因: 该表被错误删除,但 work_note_folder_tree_handler.go 还在使用
...
BEGIN
    IF NOT EXISTS (
        ...
        FOREIGN KEY (folder_id) REFERENCES work_note_folders(id) ON DELETE SET NULL;
    END IF;
END$$;
...
-- Migration 20251114_01 completed
-- Restored table: work_note_folders
-- Restored foreign key: documents.folder_id -> work_note_folders
