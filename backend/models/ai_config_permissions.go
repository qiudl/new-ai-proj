...
func GetRequiredPermissionsForEndpoint(method, path string) []string {
	...
	endpointPermissions := map[string]map[string][]string{
		...
		"GET": {
			...
			"/api/v1/system/ai-configs/:provider/rotation-history":   {PermissionAIConfigViewRotationHistory},
			"/api/v1/system/ai-configs/:provider/expiry-notifications": {PermissionAIConfigViewRotationHistory},
		},
		// POST请求
		"POST": {
			"/api/v1/system/ai-configs":                          {PermissionAIConfigCreate},
			"/api/v1/system/ai-configs/test":                     {PermissionAIConfigTest},
			"/api/v1/system/ai-configs/:provider/rotate-key":           {PermissionAIConfigRotateKey},
			"/api/v1/system/ai-configs/:provider/set-expiry":           {PermissionAIConfigManageExpiry},
			"/api/v1/system/ai-configs/:provider/enable-auto-rotation": {PermissionAIConfigAutoRotate},
			"/api/v1/system/ai-configs/:provider/disable-auto-rotation": {PermissionAIConfigAutoRotate},
