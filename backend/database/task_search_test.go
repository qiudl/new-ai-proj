...
func (m *MockTaskRepository) Create(ctx context.Context, task *models.Task) (*models.Task, error) { return nil, nil }
func (m *MockTaskRepository) GetByID(ctx context.Context, id int) (*models.Task, error) { return nil, nil }
func (m *MockTaskRepository) GetByProjectID(ctx context.Context, projectID int, limit, offset int) ([]*models.Task, int, error) { return nil, 0, nil }
func (m *MockTaskRepository) GetAll(ctx context.Context, limit, offset int) ([]*models.Task, int, error) { return nil, 0, nil }
func (m *MockTaskRepository) Update(ctx context.Context, task *models.Task) (*models.Task, error) { return nil, nil }
...
func (m *MockTaskRepository) BulkCreate(ctx context.Context, tasks []*models.Task) ([]*models.Task, error) { return nil, nil }
func (m *MockTaskRepository) UpdateStatus(ctx context.Context, id int, status string) error { return nil }
func (m *MockTaskRepository) GetByStatus(ctx context.Context, status string, limit, offset int) ([]*models.Task, int, error) { return nil, 0, nil }
func (m *MockTaskRepository) GetChildren(ctx context.Context, parentID int) ([]*models.Task, error) { return nil, nil }
func (m *MockTaskRepository) GetTaskTree(ctx context.Context, projectID int) ([]*models.HierarchicalTask, error) { return nil, nil }
func (m *MockTaskRepository) GetRootTasks(ctx context.Context, projectID int, limit, offset int) ([]*models.Task, int, error) { return nil, 0, nil }
func (m *MockTaskRepository) CreateTaskUpdate(ctx context.Context, update *models.TaskUpdate) error { return nil }
func (m *MockTaskRepository) GetTaskUpdates(ctx context.Context, taskID int, limit, offset int) ([]*models.TaskUpdate, int, error) { return nil, 0, nil }
func (m *MockTaskRepository) UpdateTaskUpdateNotes(ctx context.Context, updateID int, notes string) error { return nil }
func (m *MockTaskRepository) DeleteTaskUpdate(ctx context.Context, updateID int) error { return nil }
func (m *MockTaskRepository) CreateTimelineEvent(ctx context.Context, event *models.TimelineEvent) error { return nil }
func (m *MockTaskRepository) GetTaskTimeline(ctx context.Context, taskID int, limit, offset int) ([]*models.TimelineEvent, int, error) { return nil, 0, nil }
func (m *MockTaskRepository) GetProjectTimeline(ctx context.Context, projectID int, limit, offset int) ([]*models.TimelineEvent, int, error) { return nil, 0, nil }
