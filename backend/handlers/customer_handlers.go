...
func (h *CustomerHandler) GetCustomers(c *gin.Context) {
	...
	customers, total, err := h.db.Customers().List(c.Request.Context(), pagination.PageSize, offset, filters)
	if err != nil {
...
func (h *CustomerHandler) UpdateCustomer(c *gin.Context) {
	...
	existingCustomer.UpdatedBy = 1 // TODO: Get from authenticated user context
...
func (h *CustomerHandler) AddCustomerUser(c *gin.Context) {
	...
	err = h.db.Customers().AssociateUser(c.Request.Context(), customerID, req.UserID, req.Role, req.Permissions)
	if err != nil {
...
func (h *CustomerHandler) GetCustomerStats(c *gin.Context) {
	stats, err := h.db.Customers().GetStats(c.Request.Context())
	if err != nil {
