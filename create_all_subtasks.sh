...
TASK1_SUCCESS=$(echo "$TASK1_RESPONSE" | jq -r '.success')
echo "Task 1: success=$TASK1_SUCCESS, ID=$TASK1_ID"
...
TASK2_SUCCESS=$(echo "$TASK2_RESPONSE" | jq -r '.success')
echo "Task 2: success=$TASK2_SUCCESS, ID=$TASK2_ID"
...
TASK3_SUCCESS=$(echo "$TASK3_RESPONSE" | jq -r '.success')
echo "Task 3: success=$TASK3_SUCCESS, ID=$TASK3_ID"
...
TASK4_SUCCESS=$(echo "$TASK4_RESPONSE" | jq -r '.success')
echo "Task 4: success=$TASK4_SUCCESS, ID=$TASK4_ID"
...
TASK5_SUCCESS=$(echo "$TASK5_RESPONSE" | jq -r '.success')
echo "Task 5: success=$TASK5_SUCCESS, ID=$TASK5_ID"
...
echo ""
echo "Saving results..."
echo "$TASK1_ID,$TASK2_ID,$TASK3_ID,$TASK4_ID,$TASK5_ID" > /Users/johnqiu/coding/www/projects/new-ai-proj/subtask_ids.txt
echo "$TOKEN" > /Users/johnqiu/coding/www/projects/new-ai-proj/fresh_token.txt
echo "Done!"
