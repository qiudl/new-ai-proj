...
const DashboardPage: React.FC = () => {
  ...
  */
  ...
  // Timeline related code removed for cleaner dashboard
  ...
  */
  ...
  return (
    <div style={{ padding: '24px', background: '#f5f5f5', minHeight: '100vh' }}>
      ...
      {/* 🔽 NEW: 简化的2列布局 - 只保留任务计时器和我的任务 */}
      <div className="dashboard-simple-2-column-layout" style={{ 
        display: 'grid', 
        gridTemplateColumns: '1fr 1fr', // 左右两列等宽
        gap: '16px',
        minHeight: '600px', // 最小高度保证内容可见
        marginBottom: '24px'
      }}>
        {/* 左侧区域：任务计时器 */}
        <div className="left-timer-area" style={{
          background: '#fafafa',
          ...
          <div className="my-tasks-card" style={{ 
            ...
            <TimerErrorBoundary>
              <EnhancedHierarchicalTaskTree 
                ...
                compactMode={false} // 不使用紧凑模式，充分利用空间
              />
            </TimerErrorBoundary>
          </div>
        </div>
      ...
      {/* Timeline section removed for cleaner dashboard */}
