...
import { Task, TaskUpdate, Event } from '../types/task';
      ...
      <Row gutter={[24, 24]}>
        ...
        <Col xs={24} lg={16}>
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              ...
              <Space>
                ...
                {/* 只有已完成且未归档的任务才能归档 */}
                {task.status === 'completed' && !task.archived_at && (
                  <Tooltip title="归档任务">
                    <Button 
                      type="default" 
                      icon={<InboxOutlined />} 
                ...
                {/* 已归档任务显示归档信息 */}
                {task.archived_at && (
                  <Tooltip title={`已归档于 ${dayjs(task.archived_at).format('YYYY-MM-DD HH:mm')}`}>
                    <Button 
                      disabled
                      icon={<InboxOutlined />}
                      style={{ 
                    ...
                    <div style={{ padding: '20px' }}>
                      ...
                      <div style={{ marginBottom: '32px' }}>
                        ...
                        {task.description ? (
                          ...
                          <div style={{
                            ...
                            <FileTextOutlined style={{ fontSize: '24px', marginBottom: '8px', opacity: 0.5 }} />
                            <div style={{ fontSize: '14px' }}>暂无任务描述</div>
                      ...
                      <div>
                        <div style={{ 
                          ...
                          <BranchesOutlined style={{ color: '#52c41a', fontSize: '18px' }} />
                        ...
                        {subtasks.length > 0 ? (
                            ...
                            {subtasks.map((subtask, index) => (
                              ...
                              >
                                ...
                                <div style={{ 
                                  ...
                                  <Tag color={getStatusConfig(subtask.status).color}>
                                    {getStatusConfig(subtask.status).text}
                                  </Tag>
                                </div>
                                ...
                                <div style={{
                                  ...
                                  {subtask.due_date && (
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                                      <CalendarOutlined />
                                      截止: {dayjs(subtask.due_date).format('MM-DD')}
                                    </div>
                                  )}
                                </div>
                              </div>
                          ...
                          <div style={{
                            ...
                            <BranchesOutlined style={{ fontSize: '32px', marginBottom: '12px', opacity: 0.5 }} />
                            <div style={{ fontSize: '14px', marginBottom: '8px' }}>暂无子任务</div>
                            <div style={{ fontSize: '12px', color: '#bfbfbf' }}>
                              您可以创建子任务来分解当前任务，提高执行效率
                            </div>
                            <Button 
                              type="primary" 
                              ghost
          ...
          {taskUpdates.length > 0 && (
            ...
            >
              <Timeline
                items={taskUpdates.slice(0, 5).map((update, index) => {
                  // 获取更新类型的详细信息
              ...
              items={[
                ...
                },
                {
                  ...
                  children: taskUpdates.length > 0 ? (
                    <Timeline
                      items={taskUpdates.map((update, index) => ({
                        key: index,
                        color: 'blue',
                        children: (
                          <>
