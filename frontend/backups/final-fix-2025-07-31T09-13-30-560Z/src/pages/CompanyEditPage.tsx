...
import CompanyFormEnhanced from '../components/CompanyFormEnhanced';
...
const CompanyEditPage: React.FC = () => {
  ...
  // 处理AI快速填充
  const handleAIQuickFill = (aiInfo: AICompanyInfo) => {
    ...
    setHasChanges(true);
    message.success(`AI信息已填充，可信度: ${(aiInfo.confidence * 100).toFixed(0)}%`);
  };
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <Space>
            <AIQuickFillButton
              ...
              onFillComplete={handleAIQuickFill}
              size="middle"
            />
            <Button 
              icon={<EyeOutlined />}
