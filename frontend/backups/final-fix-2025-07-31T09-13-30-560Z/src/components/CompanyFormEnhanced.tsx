...
import { AICompanyInfo } from '../services/aiCompanyService';
import AIQuickFillButton from './AI/AIQuickFillButton';
...
const CompanyFormEnhanced: React.FC<CompanyFormEnhancedProps> = ({
  form,
  company,
  onValuesChange,
  disabled = false
  ...
  // 处理AI填充完成
  const handleAIFillComplete = (aiInfo: AICompanyInfo) => {
          ...
          <Row align="middle" justify="space-between">
            ...
            <Col>
              <AIQuickFillButton
                ...
                onFillComplete={handleAIFillComplete}
                size="small"
              />
            </Col>
          </Row>
...
export default CompanyFormEnhanced;