...
export const COMPONENT_OPTIONS: ComponentOption[] = [
  ...
  // 时间管理相关
  { name: 'TimeManagementHomePage', path: './pages/TimeManagementHomePage', description: '时间管理首页', category: '时间管理' },
  { name: 'TimeAnalysisPage', path: './pages/TimeAnalysisPage', description: '时间分析页面', category: '时间管理' },
  { name: 'TimeWeeklyReportPage', path: './pages/TimeWeeklyReportPage', description: '时间周报页面', category: '时间管理' },
  { name: 'TimeWeeklyReportPageEnhanced', path: './pages/TimeWeeklyReportPageEnhanced', description: '增强版时间周报', category: '时间管理' },
