...
// Debug panel removed for cleaner production build
import { setNavigateFunction } from './services/api';
// 导入控制台输出控制器，自动过滤生产环境不必要的日志
import './utils/consoleOverride';
import './App.css';
import './styles/task-hierarchy.css';

// Timer diagnostics removed for cleaner production build
...
const TimeWeeklyReportPageEnhanced = React.lazy(() => import('./pages/TimeWeeklyReportPageEnhanced'));
...
const AppContent: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Navigation function set successfully (removed console log for production)
  }, [navigate]);
    ...
    <div className="App">
      <Suspense fallback={<PageLoading />}>
        <Routes>
            ...
            <Route path="/time-weekly-report-enhanced" element={
              <PrivateRoute>
                <Layout>
                  <TimeWeeklyReportPageEnhanced />
                </Layout>
              </PrivateRoute>
            } />
